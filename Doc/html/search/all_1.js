...
[
  ...
  ['checkparamsifwrong',['checkParamsIfWrong',['../class_data_handler.html#a8dac2873c164d487ab09f7b9f0ee70a8',1,'DataHandler::checkParamsIfWrong(int rndSeed, int geneLength, int exposedMatch, int hostPopSize, int pathoPopSize, int patho_sp, int hostGeneNumbb, int pathoGeneNumb, int patoPerHostGeneration, int numOfHostGenerations, double hostMutationProb, double pathoMutationProb, int HeteroHomo, double hostDeletion, double hostDuplication, int maxGene, double alpha, double fixedAntigPosit)'],['../class_data_handler.html#a8bf0060e6fc9165afe0d727f2b240964',1,'DataHandler::checkParamsIfWrong(int rndSeed, int geneLength, int hostPopSize, int hostGeneNumbb, int numOfHostGenerations, double hostMutationProb, int HeteroHomo, double hostDeletion, double hostDuplication, int maxGene, int numberOfMates)']]],
