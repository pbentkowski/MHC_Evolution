...
[
  ...
  ['checkparamsifwrong',['checkParamsIfWrong',['../class_data_handler.html#a8dac2873c164d487ab09f7b9f0ee70a8',1,'DataHandler::checkParamsIfWrong(int rndSeed, int geneLength, int exposedMatch, int hostPopSize, int pathoPopSize, int patho_sp, int hostGeneNumbb, int pathoGeneNumb, int patoPerHostGeneration, int numOfHostGenerations, double hostMutationProb, double pathoMutationProb, int HeteroHomo, double hostDeletion, double hostDuplication, int maxGene, double alpha, double fixedAntigPosit)'],['../class_data_handler.html#a6dc796c674797fd787b5a3a90caaf10c',1,'DataHandler::checkParamsIfWrong(int rndSeed, int geneLength, int hostPopSize, int hostGeneNumbb, int numOfHostGenerations, double hostMutationProb, int HeteroHomo, double hostDeletion, double hostDuplication, int maxGene, double alpha)']]],
